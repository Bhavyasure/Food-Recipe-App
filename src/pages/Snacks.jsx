...
const snackData = {
  ...
  'Indian/Traditional Snacks': [
    ...
    {
      title: 'Dhokla',
      image: 'https://www.istockphoto.com/photo/mouthwatering-freshly-made-dhokla-gm2157592738-578272499',
      description: 'Steamed fermented chickpea flour cake.',
    },
    {
      title: 'Murukku',
      image: '',
...
const getDirectImageUrl = (url, title) => {
  ...
  if (!cleanedUrl) {
    if (title === 'Murukku') return 'https://images.pexels.com/photos/461357/pexels-photo-461357.jpeg';
  ...
  if (cleanedUrl.includes('istockphoto.com')) {
    if (title === 'Samosa') return 'https://images.pexels.com/photos/461326/pexels-photo-461326.jpeg';
    if (title === 'Dhokla') return 'https://images.pexels.com/photos/461360/pexels-photo-461360.jpeg';
